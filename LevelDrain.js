...
//v1.0
/*:
 * @plugindesc v1.0 Level and experience drain for enemies and actors.
 * @author Slinds
 *
...
/*:ja
 * @plugindesc v1.0敵やアクターのレベルや経験値ドレイン
 * @author Slinds
 *
 * @param Level reduced message
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
	...
	if (command.toLowerCase() === "getactorslostexp"){
		...
		if(!args[0]){
			$gameMessage.add("missing argument [enemyId] for 'getactorslostexp'")
		}
		if(!args[1]){
